...
<html>
    ...
    <body>
        ...
        <div class="row">
            <form method="GET">
            <div class="column"> <br>
                <img src="pics/pita.jpg" alt="background-image" weight="300" height="300">
            </div>                
            <div class="column1"> <br> 
                <h2>Pita</h2>
                    <h5>The weight is approx. 120g </h5> <br>

                <div id="fixedP">1.49</div><div id="price">1.49</div>
                    <button onclick="readDescription()" id="minfo">More Description</button> <br>
                    <div id="moreinfo">
                        <h6>yeast-leavened round flatbreads baked from wheat flour, common in the Mediterranean, Middle East, and neighboring areas. </h6>
                        <h6>Storage: Shelf</h6>
                        <h6>Product #:987-043</h6>
                    </div><br>
