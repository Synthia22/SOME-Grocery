...
<html>
    ...
    <body>
        ...
        <div class="row">
            <div class="column"> <br>
                <img src="pics/cookies.jpg" alt="background-image" weight="300" height="300">
            </div>                
            <div class="column1"> <br> 
                ...
                <div id="fixedP">2</div><div id="price">2</div>
                    ...
                    <div id="moreinfo">
                        <h6>Description: Chocolate Chip Cookies. Cookies beloved by kids all around the world! </h6>
                        <h6>Storage: Shelf</h6>
                        <h6>Product #: 987-066</h6>
                    </div><br>
