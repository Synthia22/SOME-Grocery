...
<body>
    ...
    <div class="row">
        ...
        <div class="column1">
            <br>
            <h2>Boneless Chipotle Chicken Breast</h2>
            <h5>The weight is approx. 370g </h5> <br>

            <div id="fixedP">9.99</div> <div id="price">9.99</div>
            <button onclick="readDescription()" id="minfo">More Description</button> <br>
            <div id="moreinfo">
                <h6>Description: Preperation time is kept to a minimal due to the chicken being pre-seasoned. </h6>
                <h6>Storage: Freezer</h6>
                <h6>Product #:987-054</h6>
            </div><br>
