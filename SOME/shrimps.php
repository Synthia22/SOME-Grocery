...
<html>
    ...
    <body>
        ...
        <div class="row">
            <form method="GET">
            <div class="column"> <br>
                <img src="pics/shrimp.JPG" alt="background-image" weight="300" height="300">
            </div>                
            <div class="column1"> <br> 
                <h2>Precooked Shrimps</h2>
                    <h5>The weight is approx. 200g </h5> <br>
                    <div id="fixedP">8.38</div> <div id="price">8.38</div>
                    <button onclick="readDescription()" id="minfo">More Description</button><br>
                    <div id="moreinfo">
                        <h6>Description: Satisfy your seafood cravings with these beautiful Shrimp. Each resealable pack contains around 70 shrimp per pound that have been cooked, deveined and peeled. </h6>
                        <h6>Storage: Freezer</h6>
                        <h6>Product #: 987-034</h6>
                    </div><br>
