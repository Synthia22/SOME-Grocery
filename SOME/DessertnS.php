...
<html>
    <head>
        <title>Desserts and Snacks</title>
    ...
    <div class="aisle">
        <div class="row">
            ...
            <div class="column border-light">
                <a href="cake.php">
                    <div>
                        <img src="pics/fig-cake.jpg" alt="background-image" weight="150" height="150">
                        <h4>Fig Cake</h4>
                        <p>25$</p>
           ...
           <?php  for($i=0;$i<$xml_->info->count();$i++){?>
             <?php if($xml_->info[$i]->Type[0] == "Dessert and Snacks")
    ...
    <!--End pf Dessert and snacks section-->
    <!--Footer-->
        <div class="bottom">
