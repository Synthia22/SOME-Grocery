...
<body>
    ...
    <div class="row">
        <div class="column">
            <br>
            <img src="photos/Lamb-Shoulder.jpg" alt="background-image" weight="300" height="300">
        </div>
        <div class="column1">
            <br>
            <h2>Fresh Boneless Lamb Shoulder Cubes</h2>
            <h5>The weight is approx. 425g </h5> <br>

            <div id="fixedP">18.95</div> <div id="price">18.95</div>
            <button onclick="readDescription()" id="minfo">More Description</button> <br>
            <div id="moreinfo">
                <h6>Description: Lamb shoulders are most popularly seasoned with lemon, oregano, and rosemary. </h6>
                <h6>Storage: Freezer</h6>
                <h6>Product #: 987-055</h6>
            </div><br>
