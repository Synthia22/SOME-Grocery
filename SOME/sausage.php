...
<body>
    ...
    <div class="row">
        ...
        <div class="column">
            <br>
            <img src="photos/Italian-Sausage.jpg" alt="background-image" weight="300" height="300">
        </div>
        <div class="column1">
            <br>
            <h2>Hot Italian Sausage</h2>
            <h5>The weight is approx. 275g </h5> <br>

           <div id="fixedP">6.89</div> <div id="price">6.89</div>
            <button onclick="readDescription()" id="minfo">More Description</button> <br>
            <div id="moreinfo">
                <h6>Description: This Italian sausage is best served with minimal seasoning since it is packaged pre-seasoned. </h6>
                <h6>Storage: Freezer</h6>
                <h6>Product #:987-052</h6>
            </div><br>
