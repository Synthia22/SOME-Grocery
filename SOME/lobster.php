...
<html>
    ...
    <body>
        ...
        <div class="row">
            <div class="column"> <br>
                <img src="pics/lobster.JPG" alt="background-image" weight="300" height="300">
            </div>                
            <div class="column1"> <br> 
                <h2>Lobster</h2>
                    <h5>The weight is approx. 501g </h5> <br>
                    <div id="fixedP">21.35</div> <div id="price">21.35</div>
                    <button onclick="readDescription()" id="minfo">More Description</button> <br>
                    <div id="moreinfo">
                        <h6>Description: SOME BRAND Cooked Lobster is perfect for those special occasions. Just defrost lobster overnight and boil for 1 minute. Sourced from and MSC certified sustainable fishery. </h6>
                        <h6>Storage: Freezer</h6>
                        <h6>Product #: 987-035</h6>
                    </div><br>
