...
<body>
    ...
    <header>
        <div class="wrapper">
            <div class="logo">
                <a href="menu.html"><i class="fas fa-seedling"></i>SOME BRAND</a>
            </div>
            <nav>
    ...
    <div class="row">
        ...
        <div class="column1">
            ...
            <div id="fixedP">25</div> <div id="price">25</div>
            <button onclick="readDescription()" id="minfo">More Description</button> <br>
            <div id="moreinfo">
                <h6>Description: The size of this egg make it perfect to pelt naughty children and make a delicious omelet. </h6>
                <h6>Storage: Shelf</h6>
                <h6>Product #:987-011</h6>
            </div><br>
