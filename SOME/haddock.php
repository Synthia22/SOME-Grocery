...
<html>
    ...
    <body>
        ...
        <div class="row">
            <div class="column"> <br>
                <img src="pics/Fresh Haddock Fillet.jpg" alt="background-image" weight="300" height="300">
            </div>                
            <div class="column1"> <br> 
                <h2>Fresh Haddock Fillet</h2>
                    <h5>The weight is approx. 200g </h5> <br>
                    <div id="fixedP">6.39</div> <div id="price">6.39</div>
                    <button onclick="readDescription()" id="minfo">More Description</button> <br>
                    <div id="moreinfo">
                        <h6>Description: A fresh fillet of Haddock caught along the cost of Canada. It is delicate, mild, yet slightly sweet in flavour.</h6>
                        <h6>Storage: Freezer</h6>
                        <h6>Product #: 987-033</h6>
                    </div><br>
