    ...
    <body>
        ...
        <div class="row">
            ...
            <div class="column1"> <br> 
                <h2>Strawberries</h2>
                    <h5>Sold in a container. Weighs around 150g. </h5> <br>

                <div id="fixedP">0.49</div> <div id="price">0.49</div>
                    <button onclick="readDescription()" id="minfo">More Description</button> <br>
                    <div id="moreinfo">
                        <h6>Description: Sweet & succulent. Blitz with low fat yogurt and oats for a super smoothie. </h6>
                        <h6>Storage: Refrigerate</h6>
                        <h6>Product #: 987-025</h6>
                    </div><br>
