...
<html>
    ...
    <body>
        ...
        <div class="row">
            <div class="column"> <br>
                <img src="pics/taiyaki.jpg" alt="background-image" weight="300" height="300">
            </div>                
            <div class="column1"> <br> 
                <h2>Taiyaki, Red Bean</h2>
                ...
                <div id="fixedP">3</div><div id="price">3</div>
                    ...
                    <div id="moreinfo">
                        <h6>Description: Red Bean Flavor Taiyaki pastry</h6>
                        <h6>Storage: Shelf</h6>
                        <h6>Product #: 987-064</h6>
                    </div><br>
