...
<body>
    ...
    <div class="row">
        <div class="column">
            <br>
            <img src="photos/Ground-Veal.jpg" alt="background-image" weight="300" height="300">
        </div>
        <div class="column1">
            <br>
            <h2>Lean Ground Veal</h2>
            <h5>The weight is approx. 255g </h5> <br>

            <div id="fixedP">4.98</div> <div id="price">4.98</div>
            <button onclick="readDescription()" id="minfo">More Description</button> <br>
            <div id="moreinfo">
                <h6>Description: Ground Veal has an expiration date of no longer than 2 weeks. </h6>
