...
<html>
    ...
    <body>
        ...
        <div class="row">
            <form method="GET">
            <div class="column"> <br>
                <img src="pics/salmon.jpg" alt="background-image" weight="300" height="300">
            </div>                
            <div class="column1"> <br> 
                <h2>Fresh Salmon</h2>
                    <h5>The weight is approx. 250g </h5> <br>
                    <div id="fixedP">7.71</div> <div id="price">7.71</div>
                    <button onclick="readDescription()" id="minfo">More Description</button> <br>
                    <div id="moreinfo">
                        <h6>Description: A sweet Atlantic salmon that has a refreshing and subtle taste.</h6>
                        <h6>Storage: Freezer</h6>
                        <h6>Product #: 987-031</h6>
                    </div><br>
