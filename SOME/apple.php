...
<html>
    ...
    <body>
        ...
        <div class="row">
            <div class="column"> <br>
                <img src="pics/apple.jpg" alt="background-image" weight="300" height="300">
            </div>                
            <div class="column1"> <br> 
                <h2>Apple, Granny Smith</h2>
                    <h5>The weight is approx. 120g </h5> <br>

                <div id="fixedP">0.99</div> <div id="price">0.99</div>
                    <button onclick="readDescription()" id="minfo">More Description</button> <br>
                    <div id="moreinfo">
                        <h6>Description: The mild yet sweet flavour has made it a favourite for snacks. It's firm with a bright green skin and a crisp delicious taste. </h6>
                        <h6>Storage: Shelf</h6>
                        <h6>Product #: 987-021</h6>
                    </div><br>
