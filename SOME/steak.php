...
<body>
    ...
    <div class="row">
        ...
        <div class="column">
            <br>
            <img src="photos/Sirloin-Steak.jpg" alt="background-image" weight="300" height="300">
        </div>
        <div class="column1">
            <br>
            <h2>3 Pepper Sirloin Steak</h2>
            <h5>The weight is approx. 480g </h5> <br>

            <div id="fixedP">11.59</div> <div id="price">11.59</div>
            <button onclick="readDescription()" id="minfo">More Description</button> <br>
            <div id="moreinfo">
                <h6>Description: This Sirloin Steak is best served when cooked at rare to medium-rare. </h6>
                <h6>Storage: Freezer</h6>
                <h6>Product #: 987-053</h6>
            </div><br>
