...
<body>
    ...
    <div class="row">
        ...
        <div class="column1">
            ...
            <div id="fixedP"> 1</div> <div id="price">1</div>
            <button onclick="readDescription()" id="minfo">More Description</button> <br>
            <div id="moreinfo">
                <h6>Description: This portion of milk would cause any lactose intolerance person to stay up all night. </h6>
                <h6>Storage: Shelf</h6>
                <h6>Product #: 987-013</h6>
            </div><br>
